...
export function isChordLine(line) {
  ...
  // Remove todos os tokens que parecem acordes e vê se sobra algo
  // Token de acorde: nota + modificadores opcionais + baixo opcional
  const chordTokenRegex = /^[A-G](?:b|#)?(?:m|M|maj|min|dim|aug|sus|add|maj7|m7|M7|7M|7|9|11|13|6|5|4|2)?(?:\/[A-G](?:b|#)?)?$/;
...
export function transposeChordLine(line, steps) {
  ...
  return line.replace(/[A-G](?:b|#)?(?:m|M|maj|min|dim|aug|sus|add|maj7|m7|M7|7M|7|9|11|13|6|5|4|2)?(?:\/[A-G](?:b|#)?)?/g, chord => transposeChord(chord, steps));
}
